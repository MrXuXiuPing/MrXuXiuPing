 ...
 */
package com.mall.websocket.service;

import cn.hutool.core.date.BetweenFormater;
import cn.hutool.core.date.DateUtil;
import com.mall.websocket.utils.FileUtil;
import com.mall.websocket.utils.StringUtils;
...
public class MonitorServiceImpl implements MonitorService {
    ...
    private Map<String,Object> getDiskInfo(OperatingSystem os) {
        ...
        System.out.println("磁盘信息："+diskInfo);
        return diskInfo;
    }
    ...
    private Map<String,Object> getMemoryInfo(GlobalMemory memory) {
        String a =FormatUtil.formatBytes(memory.getTotal());
        ...
        System.out.println("内存信息："+memoryInfo);
        return memoryInfo;
    }
